					...
					<form id="recoveryForm">
						<div style="width: 320px; margin: 30px auto;">
							...
							<ol class="e-login-options">
								...
								<li class="clearfix"><input type="text" id="u-password" class="fl" style="width: 120px;" placeholder="请输入验证码" name="pageCode" value=""> <img width="86" height="40" onclick="this.src='${ctx}/inxedu/ran/random?random='+Math.random();" alt="验证码，点击图片更换" src="${ctx}/ran/random">
									<p class="lr-tip-wrap"></p></li>
							</ol>
