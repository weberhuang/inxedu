		...
		<section >
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<c:forEach var="image" items="${aboutUsImagesList}" varStatus="status">
						<div class="swiper-slide">
							<img class="imgload" style="height: 600px;width: 1200px" src="<%=staticImage%>${image.imagesUrl}" alt="${image.title}">
						</div>
					</c:forEach>
				</div>
			</div>
