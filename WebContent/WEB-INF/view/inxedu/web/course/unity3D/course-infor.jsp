...
<body>
	<div id="aCoursesList" class="bg-fa of">
		...
		<section class="container">
			<section class="path-wrap">
				...
				\
				<a href="${ctx }/front/showcoulist_unity3d" title="" class="c-999 fsize14">课程列表</a>
										...
										<c:forEach items="${courseList}" var="interfixCourse">
											<li>
												<aside class="course-r-pic">
													<a href="${ctx }/front/couinfo_unity3d/${interfixCourse.courseId}" title="">
														<c:choose>
												...
												<section class="hLh20 txtOf">
													<a href="${ctx }/front/couinfo_unity3d/${interfixCourse.courseId}" class="c-333 fsize16">${interfixCourse.courseName}</a>
												</section>
	...
	<script>
		...
		function favorites(courseId,obj){
			if(isLogin()){
				$.ajax({
					url:baselocation+'/front/createfavorites_unity3d/'+courseId,
					type:'post',
					dataType:'json',
