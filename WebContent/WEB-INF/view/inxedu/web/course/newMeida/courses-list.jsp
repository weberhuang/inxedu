	   ...
	   <div id="aCoursesList1" class="bg-fa of">
			<section class="container">
			   <div class="swiper-slide" style="background:#FFFFFF" >
					<img class="imgload" style="height: 480px;width: 1200px" src="${ctx}/images/upload/image/20171023/newmedia_logo.png" >
				</div>	
			</section>
		</div>
	<!-- 课程Logo結束 -->
	...
	<div id="aCoursesList" class="bg-fa of">
		...
		<section class="container">
			...
			<section class="c-sort-box">
				...
				<!-- 公共分页 结束 -->
				<form action="${ctx}/front/showcoulist_newmedia" id="searchForm" method="post">
