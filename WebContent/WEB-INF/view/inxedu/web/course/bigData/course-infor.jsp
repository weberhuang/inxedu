...
<body>
	<div id="aCoursesList" class="bg-fa of">
		...
		<section class="container">
			<section class="path-wrap">
				...
				\
				<a href="${ctx }/front/showcoulist_bigdata" title="" class="c-999 fsize14">课程列表</a>
										...
										<c:forEach items="${courseList}" var="interfixCourse">
											<li>
												<aside class="course-r-pic">
													<a href="${ctx }/front/couinfo_bigdata/${interfixCourse.courseId}" title="">
														<c:choose>
	...
	<script>
		...
		function favorites(courseId,obj){
			if(isLogin()){
				$.ajax({
					url:baselocation+'/front/createfavorites_bigdata/'+courseId,
					type:'post',
					dataType:'json',
