...
<body> 
     <!-- 课程Logo開始 -->
	   <div id="aCoursesList1" class="bg-fa of">
			<section class="container">
			   <div class="swiper-slide" style="background:#FFFFFF" >
					<img class="imgload"  style="height: 480px;width: 1200px" src="${ctx}/images/upload/image/20171023/bigdata_logo.jpg" >
				</div>	
			</section>
		</div>
	<!-- 课程Logo結束 -->
	<!-- 课程Logo開始 -->
	   <div id="aCoursesList1" class="bg-fa of">
			<section class="container">
			   <div class="swiper-slide" style="background:#FFFFFF" >
					<img class="imgload"  style="height: 600px;width: 1200px" src="${ctx}/images/upload/course/bigData/1.png" >
				</div>	
			</section>
		</div>
		<div id="aCoursesList1" class="bg-fa of">
			<section class="container">
			   <div class="swiper-slide" style="background:#FFFFFF" >
					<img class="imgload"  style="height: 430px;width: 1200px" src="${ctx}/images/upload/course/bigData/2.png" >
				</div>	
			</section>
		</div>
		<div id="aCoursesList1" class="bg-fa of">
			<section class="container">
			   <div class="swiper-slide" style="background:#FFFFFF" >
					<img class="imgload"  style="height: 550px;width: 1200px" src="${ctx}/images/upload/course/bigData/3.png" >
				</div>	
			</section>
		</div>
		<div id="aCoursesList1" class="bg-fa of">
			<section class="container">
			   <div class="swiper-slide" style="background:#FFFFFF" >
					<img class="imgload"  style="height: 630px;width: 1200px" src="${ctx}/images/upload/course/bigData/4.png" >
				</div>	
			</section>
		</div>
		<div id="aCoursesList1" class="bg-fa of">
			<section class="container">
			   <div class="swiper-slide" style="background:#FFFFFF" >
					<img class="imgload"  style="height: 580px;width: 1200px" src="${ctx}/images/upload/course/bigData/5.png" >
				</div>	
			</section>
		</div>
		<div id="aCoursesList1" class="bg-fa of">
			<section class="container">
			   <div class="swiper-slide" style="background:#FFFFFF" >
					<img class="imgload"  style="height: 400px;width: 1200px" src="${ctx}/images/upload/course/bigData/6.png" >
				</div>	
			</section>
		</div>
		<div id="aCoursesList1" class="bg-fa of">
			<section class="container">
			   <div class="swiper-slide" style="background:#FFFFFF" >
					<img class="imgload"  style="height: 750px;width: 1200px" src="${ctx}/images/upload/course/bigData/7.png" >
				</div>	
			</section>
		</div>
	<!-- 课程Logo結束 -->
	...
	<div id="aCoursesList" class="bg-fa of">
		...
		<section class="container">
			...
			<section class="c-sort-box">
									...
									<li>
										<div class="cc-l-wrap">
											<section class="course-img">
												...
												<div class="cc-mask">
													<a href="${ctx}/front/couinfo_bigdata/${course.courseId}" title="" class="comm-btn c-btn-1">开始学习</a>
												</div>
											</section>
											<h3 class="hLh30 txtOf mt10">
												<a href="${ctx}/front/couinfo_bigdata/${course.courseId}" title="${course.courseName}" class="course-title fsize18 c-333">${course.courseName}</a>
											</h3>
				...
				<!-- 公共分页 结束 -->
				<form action="${ctx}/front/showcoulist_bigdata" id="searchForm" method="post">
