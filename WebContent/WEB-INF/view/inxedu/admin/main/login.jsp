...
<body>
	<div id="container">
		<div class="logo">
			<a href="http://demo1.inxedu.com/" target="_blank" title="融信教育 - 中国数据人才唯一培养单位！">
				<img src="${ctx}/static/admin/assets/logo.png" width="200" alt="融信教育 - 中国数据人才唯一培养单位！" />
			</a>
		</div>
	</div>
			...
			<div id="box">
				...
				<form action="${ctx}/admin/main/login" method="POST" id="loginForm">
					...
					<p class="main">
						...
						<span class="yzm-pic">
							<img src="${ctx}/inxedu/ran/random" alt="验证码，点击图片更换" onclick="this.src='${ctx}/ran/random?random='+Math.random();" />
						</span>
					</p>
					<p class="space">
